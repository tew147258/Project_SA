...
// UserConfirmationOrErr returns the UserConfirmation value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) UserConfirmationOrErr() ([]*Confirmation, error) {
	if e.loadedTypes[0] {
		return e.UserConfirmation, nil
	}
	return nil, &NotLoadedError{edge: "UserConfirmation"}
}
...
// QueryUserConfirmation queries the UserConfirmation edge of the User.
func (u *User) QueryUserConfirmation() *ConfirmationQuery {
	return (&UserClient{config: u.config}).QueryUserConfirmation(u)
}
